...
class OldClassesTableViewController: UITableViewController {
...
extension OldClassesTableViewController: UISearchBarDelegate {
...
extension OldClassesTableViewController: UIEmptyStateDataSource, UIEmptyStateDelegate {
...
extension OldClassesTableViewController: Segueable {
...
extension OldClassesTableViewController: UIViewControllerPreviewingDelegate {
...
extension OldClassesTableViewController: AddEditClassViewDelegate {
...
extension OldClassesTableViewController: UISplitViewControllerDelegate {
